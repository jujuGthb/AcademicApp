  ...
  return (
    <div className="home">
      <div className="hero">
        ...
        <p>
          Akademik faaliyetlerinizi kaydedin, puanlarınızı hesaplayın ve
          yükseltme başvurularınızı kolayca yönetin.
        </p>
      ...
      {/* Include the JobPostings component with isAuthenticated prop */}
      ...
      <div className="features">
        ...
        <div className="feature-grid">
          ...
          <div className="feature">
            ...
            <p>
              Yönergeye uygun olarak faaliyetlerinizin puanlarını otomatik
              hesaplayın
            </p>
          </div>
          <div className="feature">
            ...
            <p>
              Akademik yükseltme başvuruları için gerekli raporları oluşturun
            </p>
          </div>
          <div className="feature">
            <h3>Başvuru Takibi</h3>
            <p>Akademik yükseltme başvurularınızı takip edin</p>
          </div>
        </div>
      </div>
      ...
      <div className="info-section">
        ...
        <p>
          Kocaeli Üniversitesi Öğretim Üyeliği Atama ve Yükseltme Yönergesi'ne
          göre akademik yükseltme kriterleri belirlenmiştir. Sistem, bu
          kriterlere uygun olarak puanlama yapmaktadır.
        </p>
      ...
      <div className="points-section">
        <h2>Puan Tablosu</h2>
        <p>
          Akademik faaliyetlerinizin puanlarını hesaplamak için kullanılan puan
          tablosunu görüntüleyin.
        </p>

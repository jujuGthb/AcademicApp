  ...
  useEffect(() => {
    const fetchActivities = async () => {
      try {
        ...
        setError(
          "Faaliyetler alınırken bir hata oluştu. Lütfen daha sonra tekrar deneyin."
        );
        console.error(err);
      } finally {
        setLoading(false);
  ...
  const handleDelete = async (id) => {
    if (window.confirm("Bu faaliyeti silmek istediğinizden emin misiniz?")) {
      try {
        ...
        setError(
          "Faaliyet silinirken bir hata oluştu. Lütfen daha sonra tekrar deneyin."
        );
        console.error(err);
      }
    }
            ...
            <div key={activity._id} className="activity-card">
              <div className="activity-header">
                <div className="activity-category">
                  ...
                  <span className="activity-subcategory">
              ...
              <div className="activity-body">
                ...
                {activity.authors && (
                  <p className="activity-authors">{activity.authors}</p>
                )}
                {activity.description && (
                ...
                <div className="activity-points">
                  <span className="activity-base-points">
                    Baz Puan: {activity.basePoints}
                  </span>

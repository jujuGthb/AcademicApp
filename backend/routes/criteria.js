...
// @access  Private
router.get("/:id", auth, criteriaController.getCriteriaById);
...
// @access  Private
router.post("/calculate-score", auth, criteriaController.calculateScore);

// @route   POST /api/criteria/generate-table
// @desc    Generate Table 5 for application
// @access  Private
router.post("/generate-table", auth, criteriaController.generateTable5);
